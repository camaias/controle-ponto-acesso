...
public class UsuarioController {
    ...
    public Usuario createUsuario(@RequestBody Usuario usuario){
        return usuarioService.saveTipo(usuario);
    }

    @GetMapping
    public List<Usuario> getTipoList(){
        return usuarioService.findAll();

    }

    @GetMapping("/{idUsuario}")
    public ResponseEntity<Usuario> getTipoByID(@PathVariable("idUsuario") Long idUsuario) throws Exception {
